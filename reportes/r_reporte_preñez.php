...
class PDF extends tFPDF{
        ...
        function Header(){
           ...
           // Salto de línea
            ...
            $this->Cell(80);
            // Título
            $this->Cell(30,10,utf8_decode('REPORTE DE PREÑEZ'),0,0,'C');
            // Salto de línea
            $this->Ln(10);
            ...
            if($result[0]=='1'){
                ...
                foreach ($result[2]  as $row) {
                   ...
                   // $tipo = ($row['tipo_persona']==2) ? "Empleado": "Administrador"; 
                    ...
                    $this->Cell($w[1],6,$row['dat_fecha_monta'],'LR',0,'C',$fill);
                    $this->Cell($w[2],6,$row['dat_fecha_parto'],'LR',0,'C',$fill);
                     $this->Ln();
                    $fill = !$fill;
    ...
    $header = array('BOVINO', utf8_decode('FECHA DE MONTA'), utf8_decode('FECHA DE PARTO'));
    ...
    $pdf->AliasNbPages();
    $pdf->AddPage();
    $pdf->Cell(60,10,"Raza: ".$result[2][0]['nva_nom_raza'],0,0,'C');
    $pdf->Ln(10);
